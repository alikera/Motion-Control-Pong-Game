...
public class PlatformNormal implements Platform {
    ...
    public PlatformNormal(Vector2 vector2, float width, float height, GameView gameView) {
    ...
    public void draw(Canvas canvas) {
        canvas.getWidth();
        canvas.getHeight();
        float deltaW1 = (width / 2) * (float) Math.cos(Math.toRadians(degrees[2]));
        float deltaW2 = (width / 2) * (float) Math.cos(Math.toRadians(degrees[2] + 180));
        float deltaH1 = (width / 2) * (float) Math.sin(Math.toRadians(degrees[2]));
        float deltaH2 = (width / 2) * (float) Math.sin(Math.toRadians(degrees[2] + 180));
...
//        double new_acceleration = values[0];
        ...
        acceleration = new_acceleration * 0.1 + acceleration * 0.9;
